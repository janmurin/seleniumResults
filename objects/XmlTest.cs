...
namespace SeleniumResults.objects
{
    ...
    public class Filter
    {
        [XmlElement(ElementName = "cat")] public string Cat { get; set; }
    }
    ...
    public class Testcase
    {
        ...
        [XmlElement(ElementName = "reason")] public Reason Reason { get; set; }

        [XmlAttribute(AttributeName = "label")]
        public string Label { get; set; }

        [XmlAttribute(AttributeName = "site")] public string Site { get; set; }
        [XmlElement(ElementName = "failure")] public Failure Failure { get; set; }
